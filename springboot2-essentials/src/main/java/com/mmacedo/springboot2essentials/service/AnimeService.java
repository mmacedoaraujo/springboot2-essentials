...
public class AnimeService {
    ...
    static {
        animes = new ArrayList<>(List.of(new Anime(ThreadLocalRandom.current().nextLong(1, 100000),"Boku no Hero"), new Anime(ThreadLocalRandom.current().nextLong(1, 100000), "Berserk")));
    }
